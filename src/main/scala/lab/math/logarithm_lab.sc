...
object logarithm_lab {
  ...
  log2(0)                                         //> res22: Double = -Infinity
  log2(1)                                         //> res23: Double = 0.0
  log2(2)                                         //> res24: Double = 1.0
  log2(4)                                         //> res25: Double = 2.0
  log2(8)                                         //> res26: Double = 3.0
  log2(16)                                        //> res27: Double = 4.0
  log2(32)                                        //> res28: Double = 5.0
