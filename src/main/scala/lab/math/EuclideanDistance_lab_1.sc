...
import lab.math.EuclideanLabBreeze2._
...
object EuclideanDistance_lab_1 {
  val A = List(3.0, 4.1, 4.8, 6.0)                //> A  : List[Double] = List(3.0, 4.1, 4.8, 6.0)
	...
	EuclideanLabBreeze2.eucDist(X1, zeros)    //> Dec 19, 2014 11:59:33 PM com.github.fommil.jni.JniLoader liberalLoad
                                                  //| INFO: successfully loaded /var/folders/qk/q84p77h56y371pyw0vp69j1h0000gn/T/j
                                                  //| niloader4734390163183527001netlib-native_system-osx-x86_64.jnilib
