...
object Derivative_formula_1_ws {
  ...
  f_deriv(3, 5, f)                                //> res1: Double = -0.06666666666666665
  f_deriv(1, 10, f)                               //> res2: Double = -0.1
  f_deriv(1, 100, f)                              //> res3: Double = -0.01
  f_deriv(1, 2, f)                                //> res4: Double = -0.5
  f_deriv(5, 3, f)                                //> res5: Double = -0.06666666666666665
  f_deriv(100, 1, f)                              //> res6: Double = -0.01
  f_deriv(50, 51, f)                              //> res7: Double = -3.9215686274509873E-4
  f_deriv(51, 50, f)                              //> res8: Double = -3.9215686274509873E-4
  f_deriv(7, 8, f)                                //> res9: Double = -0.01785714285714285
  f_deriv(15,17, f)                               //> res10: Double = -0.00392156862745098
