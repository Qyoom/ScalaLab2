...
object scratchpad_2 {
  ...
  X dot Prob                                      //> Jan 12, 2015 8:10:10 PM com.github.fommil.jni.JniLoader liberalLoad
                                                  //| INFO: successfully loaded /var/folders/qk/q84p77h56y371pyw0vp69j1h0000gn/T/j
                                                  //| niloader7079709576061215020netlib-native_system-osx-x86_64.jnilib
                                                  //| res2: Double = 3.0
  ...
  val coStDevXV = stddev(X) * stddev(Y)           //> coStDevXV  : Double = 1.67456462003312
  // Correlation
  covXY / coStDevXV                               //> res20: Double = 1.67456462003312
}
//
//
//
